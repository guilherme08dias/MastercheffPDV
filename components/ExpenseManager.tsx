...
export const ExpenseManager: React.FC = () => {
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            {/* Header & Controls */}
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-[#1C1C1E] p-6 rounded-2xl shadow-sm border border-white/10 transition-colors">
                <div>
                    <h2 className="text-2xl font-bold text-white">Gerenciamento de Despesas</h2>
                    <p className="text-gray-400">Controle os gastos do seu negócio</p>
                </div>
                ...
                <div className="flex items-center gap-3 w-full md:w-auto">
                    <input
                        ...
                        className="px-4 py-2 bg-[#2C2C2E] border-none rounded-xl focus:ring-2 focus:ring-[#FFCC00] outline-none text-white transition-colors"
                    />
                    <button
                        onClick={() => { resetForm(); setIsModalOpen(true); }}
                        className="flex items-center gap-2 px-4 py-2 bg-[#FFCC00] text-black rounded-xl hover:bg-[#E5B800] transition-colors font-bold shadow-lg"
                    >
                        <Plus size={20} />
                        Nova Despesa
                    </button>
            ...
            <div className="bg-[#1C1C1E] border border-white/10 rounded-2xl p-6 shadow-lg">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-gray-400 font-medium">Total de Despesas ({selectedMonth})</p>
                        <h3 className="text-3xl font-black text-white">R$ {totalExpenses.toFixed(2)}</h3>
                    </div>
                </div>
            </div>
